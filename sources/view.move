...
//     //     let history = subscriptions::get_user_subscription_history(user);
//     //     let active_subs = subscriptions::get_active_subscriptions(history);
...
//     //         if (subscriptions::subscription_exists(sub_id)) {
//     //             let sub = subscriptions::get_subscription_by_id_ref(sub_id);
//     //             if (subscriptions::get_subscription_status(sub) == STATUS_ACTIVE &&
//     //                 !time::is_subscription_expired(subscriptions::get_subscription_end_time(sub))) {
