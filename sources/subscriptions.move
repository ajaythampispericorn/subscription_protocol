...
//     public fun get_active_subscriptions(history: &UserSubscriptionHistory): &vector<u64> {
//         &history.active_subscriptions
//     }

//     public fun get_past_subscriptions(history: &UserSubscriptionHistory): &vector<u64> {
//         &history.past_subscriptions
//     }
...
//     public fun get_subscription_status(sub: &UserSubscription): u8 {
//         sub.status
//     }

//     public fun get_subscription_end_time(sub: &UserSubscription): u64 {
//         sub.end_time
//     }
...
//     public fun get_user_subscription_history(user: address): &UserSubscriptionHistory acquires UserSubscriptionHistory {
//         borrow_global<UserSubscriptionHistory>(user)
//     }

//     public fun get_subscription_by_id_ref(subscription_id: u64): &UserSubscription acquires SubscriptionStore {
//         let store = borrow_global<SubscriptionStore>(@subscription);
//         table::borrow(&store.subscriptions, subscription_id)
//     }
